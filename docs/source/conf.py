...
# -*- coding: utf-8 -*-
#
# jupyter_clickable_image_widget documentation build configuration file
#
...
project = 'jupyter_clickable_image_widget'
copyright = '2019, John Welsh'
author = 'John Welsh'
...
_version_py = os.path.join(repo, 'jupyter_clickable_image_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_clickable_image_widgetdoc'
...
latex_documents = [
    (master_doc, 'jupyter_clickable_image_widget.tex', 'jupyter_clickable_image_widget Documentation',
     'John Welsh', 'manual'),
]
...
man_pages = [
    ...
    'jupyter_clickable_image_widget Documentation',
     [author], 1)
]
